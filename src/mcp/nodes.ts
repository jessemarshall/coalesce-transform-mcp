...
export function registerNodeTools(
  ...
  registerSimpleTool(server, client, "list_environment_nodes", {
  ...
  registerSimpleTool(server, client, "list_workspace_nodes", {
  ...
  registerSimpleTool(server, client, "get_environment_node", {
  ...
  registerSimpleTool(server, client, "get_workspace_node", {
  ...
  registerSimpleTool(server, client, "create_workspace_node_from_scratch", {
  ...
  registerSimpleTool(server, client, "update_workspace_node", {
  ...
  registerSimpleTool(server, client, "replace_workspace_node_columns", {
  ...
  registerSimpleTool(server, client, "convert_join_to_aggregation", {
  ...
  registerSimpleTool(server, client, "apply_join_condition", {
  ...
  registerSimpleTool(server, client, "create_workspace_node_from_predecessor", {
  ...
  registerSimpleTool(server, client, "create_node_from_external_schema", {
  ...
  registerSimpleTool(server, client, "list_workspace_node_types", {
  ...
  registerDestructiveTool(server, client, "delete_workspace_node", {
  ...
  registerSimpleTool(server, client, "complete_node_configuration", {
