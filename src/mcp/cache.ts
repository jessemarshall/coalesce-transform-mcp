...
export function registerCacheTools(
  ...
  registerSimpleTool(server, client, "cache_workspace_nodes", {
  ...
  registerSimpleTool(server, client, "cache_environment_nodes", {
  ...
  registerSimpleTool(server, client, "cache_runs", {
    title: "Cache Runs",
    description:
  ...
  registerSimpleTool(server, client, "cache_org_users", {
