...
export function registerJobTools(
  ...
  registerSimpleTool(server, client, "list_environment_jobs", {
  ...
  registerSimpleTool(server, client, "get_environment_job", {
  ...
  registerSimpleTool(server, client, "update_workspace_job", {
  ...
  registerDestructiveTool(server, client, "delete_workspace_job", {
