...
export function registerRunTools(
  ...
  registerSimpleTool(server, client, "list_runs", {
    title: "List Runs",
    description:
  ...
  registerSimpleTool(server, client, "get_run", {
    title: "Get Run",
    description:
  ...
  registerSimpleTool(server, client, "get_run_results", {
  ...
  if (!options?.skipStartRun) {
    registerSimpleTool(server, client, "start_run", {
      title: "Start Run",
      description:
  ...
  registerSimpleTool(server, client, "run_status", {
    title: "Run Status",
    description:
  ...
  registerSimpleTool(server, client, "retry_run", {
    title: "Retry Run",
    description:
  ...
  registerSimpleTool(server, client, "diagnose_run_failure", {
  ...
  registerDestructiveTool(server, client, "cancel_run", {
    title: "Cancel Run",
    description:
