...
export function registerSubgraphTools(
  ...
  registerSimpleTool(server, client, "list_workspace_subgraphs", {
  ...
  registerSimpleTool(server, client, "get_workspace_subgraph", {
  ...
  registerSimpleTool(server, client, "create_workspace_subgraph", {
  ...
  registerSimpleTool(server, client, "update_workspace_subgraph", {
  ...
  registerDestructiveTool(server, client, "delete_workspace_subgraph", {
