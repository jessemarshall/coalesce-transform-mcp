...
export function defineWorkshopTools(
  _server: McpServer,
  client: CoalesceClient
): ToolDefinition[] {
  return [
  defineSimpleTool(client, "pipeline_workshop_open", {
  ...
  defineSimpleTool(client, "pipeline_workshop_instruct", {
  ...
  defineLocalTool("get_pipeline_workshop_status", {
  ...
  defineLocalTool("pipeline_workshop_close", {
