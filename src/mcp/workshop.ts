...
export function registerWorkshopTools(
  ...
  registerSimpleTool(server, client, "pipeline_workshop_open", {
  ...
  }, (client, params) => openWorkshop(client, {
    workspaceID: validatePathSegment(params.workspaceID, "workspaceID"),
    intent: params.intent,
  }));

  registerSimpleTool(server, client, "pipeline_workshop_instruct", {
  ...
  registerLocalTool(server, "get_pipeline_workshop_status", {
  ...
  registerLocalTool(server, "pipeline_workshop_close", {
