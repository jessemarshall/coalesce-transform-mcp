...
- Use `analyze_workspace_patterns` for a compact inline profile of workspace conventions.
- Use `cache_workspace_nodes` when the full node list should bypass chat context or be reused.
