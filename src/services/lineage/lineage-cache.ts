...
export type { AncestorNode, ColumnLineageEntry, ImpactResult } from "./lineage-traversal.js";
...
export type { PropagationChange, PropagationResult } from "./lineage-propagation.js";
