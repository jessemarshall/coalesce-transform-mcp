export const ENV_METADATA = [
  ...
  },
  {
    ...
    group: "core",
    description: "Default per-request timeout for Coalesce API calls. Raise on large workspaces where paginated reads exceed the default.",
    defaultValue: "60000",
    requiredForServer: false,
    requiredForRunTools: false,
    isSecret: false,
  },
  {
    ...
    group: "core",
    description: "Per-page timeout for detail=true paginated fetches of large node lists.",
    defaultValue: "180000",
    requiredForServer: false,
    requiredForRunTools: false,
    isSecret: false,
  },
  {
    ...
    group: "core",
    description: "In-memory TTL for the workspace node-type inventory. Set to `0` to disable.",
    defaultValue: "300000",
    requiredForServer: false,
    requiredForRunTools: false,
    isSecret: false,
  },
  {
    ...
    group: "core",
    description: "In-memory TTL for the workspace node-index (id/name/type/location) cache used by SQL- and intent-ref resolution. Set to `0` to disable.",
    defaultValue: "300000",
    requiredForServer: false,
    requiredForRunTools: false,
    isSecret: false,
