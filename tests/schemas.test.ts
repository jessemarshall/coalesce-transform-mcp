...
describe("UserCredentialsSchema", () => {
  it("accepts valid KeyPair credentials without passphrase", () => {
  ...
  it("accepts valid KeyPair credentials with passphrase", () => {
    const result = UserCredentialsSchema.safeParse({
      snowflakeAuthType: "KeyPair",
      snowflakeUsername: "user",
  ...
  it("accepts valid Basic (PAT) credentials", () => {
    const result = UserCredentialsSchema.safeParse({
      snowflakeAuthType: "Basic",
      snowflakeUsername: "user",
      snowflakePassword: "pat-token-123",
      snowflakeWarehouse: "WH",
      snowflakeRole: "ROLE",
    });
    expect(result.success).toBe(true);
  ...
  it("rejects missing snowflakeUsername for KeyPair", () => {
    const result = UserCredentialsSchema.safeParse({
      snowflakeAuthType: "KeyPair",
      snowflakeKeyPairKey: "-----BEGIN PRIVATE KEY-----\nxxx\n-----END PRIVATE KEY-----",
      snowflakeWarehouse: "WH",
  ...
  it("rejects missing snowflakeUsername for Basic", () => {
    const result = UserCredentialsSchema.safeParse({
      snowflakeAuthType: "Basic",
      snowflakePassword: "pat-token-123",
      snowflakeWarehouse: "WH",
  ...
  it("rejects missing snowflakeKeyPairKey for KeyPair", () => {
    const result = UserCredentialsSchema.safeParse({
      snowflakeAuthType: "KeyPair",
      snowflakeUsername: "user",
      snowflakeWarehouse: "WH",
  ...
  it("rejects missing snowflakePassword for Basic", () => {
    const result = UserCredentialsSchema.safeParse({
      snowflakeAuthType: "Basic",
      snowflakeUsername: "user",
      snowflakeWarehouse: "WH",
  ...
  it("rejects unknown snowflakeAuthType", () => {
    const result = UserCredentialsSchema.safeParse({
  ...
  it("rejects missing snowflakeAuthType", () => {
    const result = UserCredentialsSchema.safeParse({
      snowflakeUsername: "user",
      snowflakeKeyPairKey: "-----BEGIN PRIVATE KEY-----\nxxx\n-----END PRIVATE KEY-----",
      snowflakeWarehouse: "WH",
...
describe("sanitizeResponse", () => {
  ...
  it("strips snowflakePassword from nested objects", () => {
    const input = { data: { snowflakePassword: "pat-secret", id: 1 } };
    expect(sanitizeResponse(input)).toEqual({ data: { id: 1 } });
  });
});
